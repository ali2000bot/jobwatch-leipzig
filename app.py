...
VERWALTUNG_TECHNIK_HINTS = {
    ...
    "title_good": [
        ...
        "gebäudemanager", "gebaeudemanager",
        "immobilienmanager",
...
/* ===== Link-Buttons exakt gleich klein ===== */
div[data-testid="stLinkButton"] > a {
    border-radius: 999px !important;
    padding: 0 !important;
    height: 26px !important;
...
with st.sidebar:
    ...
    max_distance_filter = st.slider("Maximale Entfernung (km)", 10, 200, 25, 5)
    ...
    with st.expander("Erweitert", expanded=False):
        ...
        max_results = st.slider("Stopp bei max. Treffern", 1000, 10000, 10000, 500)
...
with col1:
    ...
    with tab_ba:
        ...
        with cFilter:
            st.markdown(
                '<div style="font-size:0.82rem;opacity:0.7;margin-bottom:2px;">Filter</div>',
                unsafe_allow_html=True
            )
